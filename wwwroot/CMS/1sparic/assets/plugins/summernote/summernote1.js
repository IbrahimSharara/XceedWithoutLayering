		...
		3: function(t, e, n) {
			...
			var xe = function() {
				...
				return e = t, (n = [{
					...
					value: function() {
						var t = this.options.dialogsInBody ? this.$body : this.options.container,
							e = ['<p class="text-center">', '<a href="../../../../../../summernote.org/index.html" target="_blank">Summernote 0.8.18</a> Ã‚Â· ', '<a href="../../../../../../github.com/summernote/summernote.html" target="_blank">Project</a> Ã‚Â· ', '<a href="../../../../../../github.com/summernote/summernote/issues.html" target="_blank">Issues</a>', "</p>"].join("");
						this.$dialog = this.ui.dialog({
