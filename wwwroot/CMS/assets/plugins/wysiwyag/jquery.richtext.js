    ...
    $.fn.richText = function( options ) {
        ...
        $editor.find(".richText-help").on("click", function() {
            ...
            if($editor) {
                ...
                var $inner = $('<div />', {class: 'richtext-info', style: 'position:relative;margin:60px auto;padding:20px;background-color:#FAFAFA;width:70%;font-family:Calibri,Verdana,Helvetica,sans-serif;font-size:small;'});
                ...
                $content.append('<hr><br>Powered by <a href="../../../../../../themeforest.net/user/sprukotechnologies.html" target="_blank">SPARIC</a>');
